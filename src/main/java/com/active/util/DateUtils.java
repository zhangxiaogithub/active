...
public class DateUtils {
	...
	public static Date stringToDate(String dateString, String pattern) throws ParseException {
		return parseDate(pattern, dateString);
	}
	...
	public static String changePattern(String dateString, String pattern) throws ParseException {
		Date stringToDateYyyyMMddhhmmss = stringToDateYyyyMMddhhmmss(dateString);
	 ...
	 */
	public static int daysBetweenTwoDate(String date1, String date2) throws ParseException {
	...
	public static int daysBetweenTwoDate(Date date1, Date date2) {
		date1 = parseDate(YYYY_MM_DD, formatDate(date1, YYYY_MM_DD));
		date2 = parseDate(YYYY_MM_DD, formatDate(date2, YYYY_MM_DD));
